...
(t,e),t!==S.current&&F(function(e){return e+1})},[]),T=(0,i.useCallback)(function(e,t){return new Promise(function(r,s){var n=h.validate(e,t);null==n?r(z):P(n)?n.then(function(e){r(e||z)},function(e){s(e)}):r(n)})},[h.validate]),O=(0,i.useCallback)(function(e,t){var r=h.validationSchema,s=I(r)?r(t):r,n=t&&s.validateAt?s.validateAt(t,e):W(e,s);return new Promise(function(e,t){n.then(function(){e(z)},function(r){// Yup will throw a validation error if validation fails. We catch those and
...
return X(function(){t.current=e}),(0,i.useCallback)(function(){for(var e=arguments.length,r=Array(e),s=0;s<e;s++)r[s]=arguments[s];return t.current.apply(void 0,r)},[])}function Q(e){var t=T(),r=t.getFieldProps,s=t.getFieldMeta,n=t.getFieldHelpers,a=t.registerField,o=t.unregisterField,l=A(e)?e:{name:e},u=l.name,c=l.validate;(0,i.useEffect)(function(){return u&&a(u,{validate:c}),function(){u&&o(u)}},[a,o,u,c]),u||(0,p.default)(!1);var f=(0,i.useMemo)(function(){return n(u)},[n,u]);return[r(l),s(u),f]}function J(e){var t=e.validate,r=e.name,s=e.render,n=e.children,a=e.as,o=e.component,l=e.className,u=k(e,["validate","name","render","children","as","component","className"]),c=k(T(),["validate","validationSchema"]),f=c.registerField,p=c.unregisterField;(0,i.useEffect)(function(){return f(r,{validate:t}),function(){p(r)}},[f,p,r,t]);var d=c.getFieldProps(_({name:r},u)),m=c.getFieldMeta(r),h={field:d,form:c};if(s)return s(_({},h,{meta:m}));if(I(n))return n(_({},h,{meta:m}));if(o){// This behavior is backwards compat with earlier Formik 0.9 to 1.x
...
var r=e.action,s=k(e,["action"]),n=T(),a=n.handleReset,o=n.handleSubmit;return(0,i.createElement)("form",_({onSubmit:o,ref:t,onReset:a,action:null!=r?r:"#"},s))});/**
...
function L(e,t=new Map){let r;if(T(e)||!e||"object"!=typeof e)return e;if(t.has(e))return t.get(e);if(e instanceof Date)// Date
...
function(e,t=[]){let r=[],s=new Set,n=new Set(t.map(([e,t])=>`${e}-${t}`));function o(e,t){let o=(0,a.split)(e)[0];s.add(o),n.has(`${t}-${o}`)||r.push([t,o])}for(let t of Object.keys(e)){let r=e[t];s.add(t),C.isRef(r)&&r.isSibling?o(r.path,t):T(r)&&"deps"in r&&r.deps.forEach(e=>o(e,t))}return(0,i.default).array(Array.from(s),r).reverse()}(e,t),r._sortErrors=ei(Object.keys(e)),t&&(r._excludedEdges=t),r}shape(e,t=[]){return this.clone().withMutation(r=>{let s=r._excludedEdges;// XXX: excludes here is wrong
...
let t=this.clone();if(!T(e))throw TypeError("`array.of()` sub-schema must be a valid yup schema not: "+h(e));return(// @ts-expect-error readonly
...
;
//# sourceMappingURL=Checkout.1725026d.js.map
