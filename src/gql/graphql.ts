...
export type ListedOrderLinesFragment = { __typename?: 'OrderLine', id: string, quantity: number, featuredAsset?: { __typename?: 'Asset', preview: string } | null, productVariant: { __typename?: 'ProductVariant', name: string, price: any, currencyCode: CurrencyCode, product: { __typename?: 'Product', slug: string } } } & { ' $fragmentName'?: 'ListedOrderLinesFragment' };
