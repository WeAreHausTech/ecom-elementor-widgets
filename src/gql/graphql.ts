...
export type ListedProductFragment = { __typename?: 'SearchResult', productId: string, productName: string, slug: string, description: string, score: number, currencyCode: CurrencyCode, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any }, priceWithTax: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any } } & { ' $fragmentName'?: 'ListedProductFragment' };
