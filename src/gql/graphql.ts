...
export type ListedOrderLinesFragment = { __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, price: any, priceWithTax: any, currencyCode: CurrencyCode, product: { __typename?: 'Product', id: string, slug: string } } } & { ' $fragmentName'?: 'ListedOrderLinesFragment' };

export type OrderPriceDataFragment = { __typename?: 'Order', subTotal: any, totalWithTax: any, shipping: any, shippingWithTax: any, currencyCode: CurrencyCode, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any, taxBase: any }> } & { ' $fragmentName'?: 'OrderPriceDataFragment' };

export type OrderDetailFragment = { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, totalQuantity: number, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string } }>, lines: Array<(
    { __typename?: 'OrderLine' }
    & { ' $fragmentRefs'?: { 'ListedOrderLinesFragment': ListedOrderLinesFragment } }
