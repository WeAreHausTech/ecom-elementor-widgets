...
export type OrderFilterParameter = {
  CustomerMessage?: InputMaybe<StringOperators>;
  active?: InputMaybe<BooleanOperators>;
  code?: InputMaybe<StringOperators>;
  createdAt?: InputMaybe<DateOperators>;
  currencyCode?: InputMaybe<StringOperators>;
  id?: InputMaybe<IdOperators>;
  newCustomer?: InputMaybe<BooleanOperators>;
...
export type OrderSortParameter = {
  CustomerMessage?: InputMaybe<SortOrder>;
  code?: InputMaybe<SortOrder>;
  createdAt?: InputMaybe<SortOrder>;
  id?: InputMaybe<SortOrder>;
  newCustomer?: InputMaybe<SortOrder>;
...
export type UpdateOrderCustomFieldsInput = {
  ...
  newCustomer?: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type ListedOrderAdressOrderFragment = { __typename?: 'OrderAddress', fullName?: string | null, company?: string | null, streetLine1?: string | null, streetLine2?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, country?: string | null, countryCode?: string | null, phoneNumber?: string | null } & { ' $fragmentName'?: 'ListedOrderAdressOrderFragment' };
...
export type SetOrderBillingAddressMutation = { __typename?: 'Mutation', setOrderBillingAddress: { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename?: 'Order', billingAddress?: (
      { __typename?: 'OrderAddress' }
      & { ' $fragmentRefs'?: { 'ListedOrderAdressOrderFragment': ListedOrderAdressOrderFragment } }
    ) | null } };

export type ActiveOrderShippingAddressQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderShippingAddressQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', shippingAddress?: (
      { __typename?: 'OrderAddress' }
      & { ' $fragmentRefs'?: { 'ListedOrderAdressOrderFragment': ListedOrderAdressOrderFragment } }
    ) | null } | null };

export type ActiveOrderBillingAddressQueryVariables = Exact<{ [key: string]: never; }>;


export type ActiveOrderBillingAddressQuery = { __typename?: 'Query', activeOrder?: { __typename?: 'Order', billingAddress?: (
      { __typename?: 'OrderAddress' }
      & { ' $fragmentRefs'?: { 'ListedOrderAdressOrderFragment': ListedOrderAdressOrderFragment } }
    ) | null } | null };
...
export type SetOrderCustomFieldsMutation = { __typename?: 'Mutation', setOrderCustomFields: { __typename?: 'NoActiveOrderError', errorCode: ErrorCode, message: string } | { __typename?: 'Order' } };

export type EligibleShippingMethodsFragment = { __typename?: 'ShippingMethodQuote', id: string, name: string } & { ' $fragmentName'?: 'EligibleShippingMethodsFragment' };

export type EligibleShippingMethodQueryVariables = Exact<{ [key: string]: never; }>;


export type EligibleShippingMethodQuery = { __typename?: 'Query', eligibleShippingMethods: Array<(
    { __typename?: 'ShippingMethodQuote' }
    & { ' $fragmentRefs'?: { 'EligibleShippingMethodsFragment': EligibleShippingMethodsFragment } }
  )> };
...
export type GetActiveOrderQuery = { __typename?: 'Query', activeOrder?: (
    { __typename?: 'Order', lines: Array<(
      { __typename?: 'OrderLine' }
      & { ' $fragmentRefs'?: { 'ListedOrderLinesFragment': ListedOrderLinesFragment } }
    )> }
    & { ' $fragmentRefs'?: { 'OrderDetailFragment': OrderDetailFragment;'OrderPriceDataFragment': OrderPriceDataFragment } }
  ) | null };
...
export type GetOrderByCodeQuery = { __typename?: 'Query', orderByCode?: (
    { __typename?: 'Order' }
    & { ' $fragmentRefs'?: { 'OrderDetailFragment': OrderDetailFragment } }
  ) | null };
...
export type AddItemToOrderMutation = { __typename?: 'Mutation', addItemToOrder: { __typename?: 'InsufficientStockError', errorCode: ErrorCode, message: string } | { __typename?: 'NegativeQuantityError', errorCode: ErrorCode, message: string } | (
    { __typename?: 'Order' }
    & { ' $fragmentRefs'?: { 'OrderDetailFragment': OrderDetailFragment } }
...
export type ListedOrderLinesFragment = { __typename?: 'OrderLine', id: string, unitPriceWithTax: any, linePriceWithTax: any, quantity: number, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, productVariant: { __typename?: 'ProductVariant', id: string, name: string, sku: string, price: any, priceWithTax: any, currencyCode: CurrencyCode, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, product: { __typename?: 'Product', id: string, slug: string } } } & { ' $fragmentName'?: 'ListedOrderLinesFragment' };

export type OrderPriceDataFragment = { __typename?: 'Order', subTotal: any, subTotalWithTax: any, total: any, totalWithTax: any, shipping: any, shippingWithTax: any, currencyCode: CurrencyCode, taxSummary: Array<{ __typename?: 'OrderTaxSummary', description: string, taxRate: number, taxTotal: any, taxBase: any }> } & { ' $fragmentName'?: 'OrderPriceDataFragment' };

export type OrderDetailFragment = { __typename: 'Order', id: string, code: string, active: boolean, createdAt: any, state: string, totalQuantity: number, currencyCode: CurrencyCode, customer?: { __typename?: 'Customer', id: string, firstName: string, lastName: string, emailAddress: string } | null, shippingAddress?: { __typename?: 'OrderAddress', fullName?: string | null, streetLine1?: string | null, streetLine2?: string | null, company?: string | null, city?: string | null, province?: string | null, postalCode?: string | null, countryCode?: string | null, phoneNumber?: string | null } | null, shippingLines: Array<{ __typename?: 'ShippingLine', priceWithTax: any, shippingMethod: { __typename?: 'ShippingMethod', id: string, name: string } }>, lines: Array<(
    { __typename?: 'OrderLine' }
    & { ' $fragmentRefs'?: { 'ListedOrderLinesFragment': ListedOrderLinesFragment } }
  )>, payments?: Array<{ __typename?: 'Payment', id: string, state: string, method: string, amount: any, metadata?: any | null }> | null } & { ' $fragmentName'?: 'OrderDetailFragment' };
...
export type EligiblePaymentMethodsFragment = { __typename?: 'PaymentMethodQuote', id: string, name: string, description: string, code: string } & { ' $fragmentName'?: 'EligiblePaymentMethodsFragment' };

export type EligiblePaymentMethodsQueryVariables = Exact<{ [key: string]: never; }>;


export type EligiblePaymentMethodsQuery = { __typename?: 'Query', eligiblePaymentMethods: Array<(
    { __typename?: 'PaymentMethodQuote' }
    & { ' $fragmentRefs'?: { 'EligiblePaymentMethodsFragment': EligiblePaymentMethodsFragment } }
  )> };

export type ListedProductFragment = { __typename?: 'SearchResult', sku: string, productId: string, productVariantId: string, productName: string, slug: string, description: string, score: number, inStock: boolean, currencyCode: CurrencyCode, facetIds: Array<string>, facetValueIds: Array<string>, collectionIds: Array<string>, productAsset?: { __typename?: 'SearchResultAsset', id: string, preview: string } | null, price: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any }, priceWithTax: { __typename?: 'PriceRange', min: any, max: any } | { __typename?: 'SinglePrice', value: any } } & { ' $fragmentName'?: 'ListedProductFragment' };

export type ListedCollectionFragment = { __typename?: 'Collection', id: string, name: string, slug: string, parentId: string, parent?: { __typename?: 'Collection', id: string, name: string, slug: string } | null, productVariants: { __typename?: 'ProductVariantList', totalItems: number }, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null } & { ' $fragmentName'?: 'ListedCollectionFragment' };
...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<(
      { __typename?: 'SearchResult' }
      & { ' $fragmentRefs'?: { 'ListedProductFragment': ListedProductFragment } }
    )>, facetValues: Array<{ __typename?: 'FacetValueResult', count: number, facetValue: { __typename?: 'FacetValue', id: string, name: string, facet: { __typename?: 'Facet', id: string, name: string } } }>, collections: Array<{ __typename?: 'CollectionResult', count: number, collection: (
        { __typename?: 'Collection' }
        & { ' $fragmentRefs'?: { 'ListedCollectionFragment': ListedCollectionFragment } }
      ) }> } };

export type TopSearchQueryVariables = Exact<{
  input: SearchInput;
}>;


export type TopSearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', totalItems: number, items: Array<(
      { __typename?: 'SearchResult' }
      & { ' $fragmentRefs'?: { 'ListedProductFragment': ListedProductFragment } }
    )>, collections: Array<{ __typename?: 'CollectionResult', count: number, collection: (
        { __typename?: 'Collection' }
        & { ' $fragmentRefs'?: { 'ListedCollectionFragment': ListedCollectionFragment } }
      ) }> } };
