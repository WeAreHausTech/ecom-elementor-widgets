...
class CurrencyChooser extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        echo '<div id="' . $widget_id . '" data-vendure-token="' . VENDURE_TOKEN .'"  data-vendure-api-url="' . VENDURE_API_URL .'" class="ecom-components-root" data-widget-type="currency-chooser"></div>';
        ?>
